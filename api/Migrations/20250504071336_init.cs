        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolIdNumber = table.Column<int>(type: "int", maxLength: 5, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    IsRfidPaymentEnabled = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "4a0f28ac-de33-47f6-8651-5c3aa89f4192", null, "User", "USER" },
                    { "99cae69f-45c1-4ca3-bc9e-c7f03d24b28c", null, "Merchant", "MERCHANT" },
                    { "d25d445c-fb30-4d9e-9bf8-03cfc63f6a6d", null, "Admin", "ADMIN" }
                });
