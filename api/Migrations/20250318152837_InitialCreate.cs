        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PinHash = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChildTransactionId = table.Column<int>(type: "int", nullable: false),
                    Id = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionRelations", x => new { x.ParentTransactionId, x.ChildTransactionId });
                    table.ForeignKey(
                        name: "FK_TransactionRelations_Transactions_ChildTransactionId",
                        column: x => x.ChildTransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TransactionRelations_Transactions_ParentTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransactionRelations_ChildTransactionId",
                table: "TransactionRelations",
                column: "ChildTransactionId");
